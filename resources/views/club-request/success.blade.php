...
<div class="flex-1 flex items-center justify-center px-6 py-16">
    <div class="max-w-md w-full text-center">
        ...
        <p class="text-gray-500 leading-relaxed mb-8">
            Bedankt voor uw aanmelding. Wij nemen binnen <strong class="text-gray-700">twee werkdagen</strong> contact op via het opgegeven e-mailadres om de inrichting van uw club te bespreken.
        </p>
