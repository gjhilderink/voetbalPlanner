        ...
        <div class="mt-12 flex flex-col items-center gap-3">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3">
                ...
                <a href="https://apps.apple.com/nl/app/voetbalplanner/id6773810390"
                   ...
                   class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/25 hover:border-white/40 rounded-xl px-4 py-2.5 text-white transition-colors">
