...
abstract final class Structs {
  ...
  static final ffai.StructHandle liveMatchState = ffai.StructHandle(
    ...
    <String, ffai.DslType>{
      ...
      "canPause": ffai.string,
      "canResume": ffai.string,
      ...
      "opponentLogo": ffai.string,
      "period": ffai.string,
      "periodCount": ffai.string,
      "periodLabel": ffai.string,
      "periodNumber": ffai.string,
      "resumeLabel": ffai.string,
  ...
  static final ffai.StructHandle motmRow = ffai.StructHandle(
    "MotmRow",
    <String, ffai.DslType>{
      "isMine": ffai.string,
      "isWinner": ffai.string,
      "memberId": ffai.string,
      "name": ffai.string,
      "photoUrl": ffai.string,
      "votes": ffai.string,
  ...
  static final ffai.StructHandle teamStats = ffai.StructHandle(
    ...
    <String, ffai.DslType>{
      ...
      "myRedCards": ffai.string,
      "myTrainings": ffai.string,
      "myYellowCards": ffai.string,
      "played": ffai.string,
      "points": ffai.string,
      "record": ffai.string,
      "seasonLabel": ffai.string,
      "standingAvailable": ffai.string,
      "standingGoalDifference": ffai.string,
      "standingMessage": ffai.string,
      "standingPlayed": ffai.string,
      "standingPoints": ffai.string,
      "standingPosition": ffai.string,
      "standingTeams": ffai.string,
      "won": ffai.string,
    },
    description: ffai.generatedProjectStructDescription,
  );
  static final ffai.StructHandle trainingItem = ffai.StructHandle(
    ...
    <String, ffai.DslType>{
      ...
      "is_afgelast": ffai.string,
      "location": ffai.string,
      "mag_afgelasten": ffai.string,
