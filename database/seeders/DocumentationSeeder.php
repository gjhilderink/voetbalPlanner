    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                'category'   => 'app',
                'sort_order' => 47,
                'title'      => 'Man of the match kiezen',
                'body'       => "Staat de stemming voor jouw elftal aan, dan kies je na afloop samen wie de man of the match was. De knop staat op het tabblad **Info** van de wedstrijd.\n\n**Wanneer verschijnt de knop?**\nPas als er een wedstrijdverslag is. Zonder verslag weet niemand waar hij over stemt, en bij een wedstrijd die nog gespeeld moet worden hoort er geen stemknop te staan.\n\n**Hoe het gaat**\nJe ziet de spelers die meededen — de opstelling, basis en wissels. Tik er een aan en bevestig met **Stem uitbrengen**. Je eigen naam staat er niet tussen: op jezelf stemmen kan niet.\n\n**Eén stem, en die is definitief.** Je kunt hem daarna niet meer wijzigen. Wie de stand al ziet en dan nog mag schuiven, bepaalt de uitslag in zijn eentje.\n\n**De uitslag** zie je zodra je zelf gestemd hebt: de namen met hun aantal stemmen, en een ster bij wie voorstaat. Daarvóór staan er geen aantallen — anders stemt iedereen op de koploper. Staan er twee gelijk, dan staan ze er allebei.\n\n**Anoniem.** Niemand kan zien wie op wie heeft gestemd. Ook de coach niet, en ook in de portal niet: daar staat alleen de uitslag.",
            ],
            // ── Het Platform ─────────────────────────────────────────────────
            [
                'category'   => 'platform',
            ...
            [
                ...
                'body'       => "Onder **Leden → Ouder/Verzorger** staan alle koppelverzoeken van je club, nieuwste eerst, met hun status. Staat er een verzoek open, dan zie je het aantal als oranje cijfer naast het menu-item.\n\n**Statussen**\n- *In afwachting* — verzonden, het lid heeft nog niet gereageerd.\n- *Verlopen* — veertien dagen voorbij zonder reactie. Er valt niets meer aan te doen; de ouder dient een nieuw verzoek in. De nachtelijke taak (`php artisan guardian:expire`) zet deze daarna op Geweigerd.\n- *Goedgekeurd* — de ouder/verzorger heeft toegang tot de gegevens van het lid.\n- *Geweigerd* — het lid heeft geweigerd, of het verzoek was verlopen.\n- *Ingetrokken* — beëindigd door het lid, de ouder of een beheerder.\n\n**Goedkeuren of weigeren namens het lid**\nNormaal bevestigt het lid zelf in de app. Lukt dat niet — geen app, geen e-mailadres, of het blijft simpelweg liggen — dan kun je het hier afhandelen met **Goedkeuren** of **Weigeren**. Dat kan alleen zolang het verzoek écht openstaat; een verlopen verzoek kun je niet alsnog goedkeuren, want dan zou de vervaltermijn niets meer voorstellen.\n\nDoe dit alleen als je zeker weet dat de koppeling klopt: je geeft iemand toegang tot de gegevens van een ander lid. De ouder/verzorger krijgt een melding in de app waarin staat dat de club het heeft goedgekeurd.\n\n**Intrekken**\nEen lopend of goedgekeurd verzoek trek je in met **Intrekken**. De koppeling vervalt meteen.\n\n**Beveiliging**\n- Een ouder vindt een lid alleen met het juiste lidnummer én de achternaam.\n- Maximaal 5 verzoeken per minuut per account.\n- Club-scoping: een ouder kan alleen leden binnen de eigen club zoeken.",
            ],
            [
                'category'   => 'platform',
                'sort_order' => 16,
            ...
            [
                ...
                'body'       => "Bij een activiteit in de agenda kun je toegangscontrole regelen. Twee dingen los van elkaar: uitgedeelde codes, en de persoonlijke code van leden.\n\n**Gratis voor leden**\nOpen het agenda-item en zet onder Toegangscontrole de schakelaar **Gratis voor leden** aan. Vanaf dat moment werkt het lidnummer van elk clublid bij de ingang, één keer per activiteit. Leden vinden hun eigen QR in de app onder Mijn toegangscode; jij hoeft ze niets te sturen.\n\n**Codes uitdelen**\nGa naar **Toegangscodes** en kies de activiteit. Je hebt drie manieren om aan codes te komen — vier als de ticketshop aanstaat, want dan komen verkochte kaarten er vanzelf bij, met de naam van de koper erop:\n- **Codes genereren** — zeg hoeveel je er wilt en hoe vaak elke code mag worden gebruikt. De app verzint leesbare codes zonder 0, O, 1 en I, want die haalt niemand foutloos over.\n- **Importeren** — een Excel-bestand met één kolom `code`. Een kolom `omschrijving` mag erbij, bijvoorbeeld een naam. Codes die al bij deze activiteit staan worden overgeslagen, dus je kunt dezelfde lijst gerust nog eens inlezen om er wat aan toe te voegen.\n- **Code toevoegen** — één losse code met de hand.\n\n**Uitdelen**\nTwee manieren, en het verschil zit niet in de opmaak maar in wat er daarna bekend is.\n- **PDF-vel** geeft alle codes van een activiteit als QR's op A4, drie per rij, met stippellijnen om te knippen. Een stapel losse codes voor achter de balie. Codes die al verkocht of uitgegeven zijn blijven eraf, tenzij je die schakelaar uitzet.\n- **Vouchers uitgeven** geeft elke code een eigen A4 met de QR, de activiteit, de datum en de locatie erop: een kaart om mee te geven of te versturen. De stapel wordt tegelijk vastgelegd als bestelling onder **Bestellingen**, en in de kolom Uitgegeven zie je daarna bij welke codes dat gebeurd is. Dáár zit het verschil — een code die al is afgedrukt komt niet nog eens in een volgende stapel terecht. Vul je een naam in, dan staat die op elke voucher. Hoort de stapel bij een kaartsoort uit de winkel, kies die dan bij Afboeken: de plekken gaan dan van de online voorraad af, zodat dezelfde stoel niet ook nog verkocht wordt.\n\nVouchers uitgeven staat er alleen als de ticketshop aanstaat; de uitgifte komt immers bij de bestellingen terecht. Raakt een afgedrukt vel zoek, trek dan die bestelling in — de vouchers worden bij de ingang geweigerd en de codes blijven als uitgegeven staan.\n\nWil je er één vervangen, dan open je die code en gebruik je de downloadknop bij de QR.\n\n**Tijdens en na afloop**\nIn de kolom Gebruikt zie je per code hoe vaak hij is gescand; hij kleurt rood zodra hij op is. Onder **Binnenkomsten** staat wie er binnen is, met naam bij een lid en de code of omschrijving bij een uitgedeelde code.\n\n**Iets rechtzetten?** Een code die per ongeluk is afgestreept zet je terug met de knop Teller terugzetten. Bij een lid haal je de regel weg bij Binnenkomsten; daarna kan hij weer naar binnen. Een code die helemaal niet meer mag werken zet je op niet-actief — dan blijft hij wel in het overzicht staan.\n\n**Wie mag dit?** Superbeheerders, clubbeheerders, en gebruikers met de rol **Toegangscontrole**. Die rol ken je toe bij Gebruikers; hij geeft alleen toegang tot toegangscodes en het scannen in de app, verder tot niets.",
            ],
            [
                'category'   => 'platform',
                'sort_order' => 20,
                'title'      => 'Ticketshop',
                'body'       => "Met de ticketshop verkoop je online kaarten voor een activiteit. De koper betaalt met iDEAL en krijgt zijn QR-codes per mail; die werken meteen bij de ingang, want het zijn gewone toegangscodes.\n\n**Aanzetten**\nGa naar Instellingen → Modules. Toegangscontrole moet aanstaan — een verkocht kaartje ís een toegangscode, dus zonder dat is er niets te verkopen. Zet daarna Ticketshop aan.\n\n**Pay.nl koppelen**\nOnder Instellingen → Ticketshop vul je de gegevens van je eigen Pay.nl-account in: het service-ID (SL-…), de tokencode (AT-…) en het API-token. Het geld komt rechtstreeks op de rekening van de club binnen; VoetbalPlanner zit er niet tussen.\n\nLaat **Testmodus** aan zolang je aan het proberen bent. Dan wordt er niets echt afgeschreven. Zet hem uit op het moment dat je echt gaat verkopen — dat is één vinkje en het is zo vergeten.\n\nHet API-token wordt versleuteld bewaard en nooit teruggetoond. Wil je het later niet wijzigen, laat het veld dan leeg; opslaan met een leeg veld laat het staan zoals het was.\n\n**Kaarten klaarzetten**\nOpen het agenda-item en ga naar het tabblad Kaartsoorten. Per soort geef je een naam, een prijs, hoeveel er zijn en hoeveel iemand er in één bestelling mag kopen. Bijvoorbeeld: Volwassene € 7,50 (120 stuks), Kind t/m 12 € 3,50 (40 stuks).\n\nVoorraad leeglaten betekent onbeperkt; nul betekent uitverkocht. Zolang er geen kaartsoort is, staat de activiteit niet in de winkel. Een soort waarvan al kaarten verkocht zijn kun je niet verwijderen — zet hem op niet te koop.\n\n**Je winkel**\nHet adres staat bij Instellingen → Ticketshop en ziet eruit als voetbalplanner.nl/jouw-club/ticketshop. Die link kun je overal delen.\n\nWil je de winkel in je eigen website? Daar staat ook een regel HTML die je in een WordPress-pagina plakt. De winkel verschijnt dan in je eigen site en groeit vanzelf mee in hoogte.\n\n**Bestellingen**\nOnder Beheer → Bestellingen zie je alles: wie, wat, hoeveel, en of er betaald is. Per bestelling kun je de kaarten met QR bekijken — handig als iemand belt omdat zijn mail niet is aangekomen — en de mail opnieuw sturen.\n\nIn de kolom **Herkomst** staat waar een bestelling vandaan komt. **Winkel** is online gekocht en betaald. **Uitgegeven** is een stapel vouchers die de club zelf heeft afgedrukt bij Toegangscodes: die staat op betaald omdat de kaarten geldig zijn en de plekken vergeven, maar er is nooit geld langsgekomen. Met **Kaarten als pdf** druk je zo'n stapel opnieuw af als er eentje in de printer is blijven steken.\n\nEen bestelling intrekken zet de kaarten op niet-actief; ze worden dan bij de ingang geweigerd. **Het geld terugstorten doe je bij Pay.nl zelf**; dat gebeurt hier niet.\n\n**Opruimen na afloop**\nBestellingen van een activiteit die geweest is kun je weggooien. Zet het filter Periode op *Activiteit is geweest*, vink aan wat weg mag en kies Verwijderen achter de drie puntjes; bij één bestelling staat de knop in de rij zelf. Er verdwijnt meer dan de regel uit de lijst: de kaarten van die bestelling en de binnenkomsten die daarop staan gaan mee, en dat is niet terug te draaien — het verkoopoverzicht van die activiteit is daarna dus ook weg. Wat nog moet komen blijft staan, behalve verlopen en mislukte bestellingen: daar is nooit een kaart uit gekomen. Moeten de kaarten alleen geweigerd worden bij de ingang, gebruik dan Intrekken. Opruimen mag door superbeheerders en clubbeheerders, niet door de rol Toegangscontrole.\n\n**Wat gebeurt er bij een afgebroken betaling?**\nDe kaarten blijven een half uur gereserveerd en komen daarna vanzelf weer vrij. De bestelling blijft zichtbaar met de status Verlopen, zodat je kunt terugkijken als iemand belt.",
            ],
            [
                'category'   => 'platform',
                'sort_order' => 21,
                'title'      => 'Ruimtes reserveren',
                'body'       => "Met de module Ruimtes verdeel je de kantine, de bestuurskamer en de kleedkamers, en zie je in één weekoverzicht wat er vrij is. Reserveringen kunnen ook in de agenda van Microsoft 365 komen te staan.\n\n**Aanzetten**\nGa naar Instellingen → Modules en zet Ruimtes aan. Geef daarna bij Gebruikers de rol **Ruimteplanning** aan wie de ruimtes mag indelen. Zonder die rol ziet iemand de module nergens — ook niet in de app.\n\n**Ruimtes klaarzetten**\nOnder Beheer → Ruimtes maak je ze aan: een naam, eventueel het aantal personen en een kleur. Die kleur is geen opsmuk: met vijf ruimtes naast elkaar in het weekrooster lees je kleur sneller dan tekst.\n\n**Het weekoverzicht**\nPlanning → Ruimteplanner toont de week met de ruimtes als rijen. Klik op een leeg vak om te reserveren — de ruimte en de dag staan dan al ingevuld. Klik op een blok om het aan te passen, of op het kruisje om het in te trekken.\n\n**Bij een activiteit**\nOpen een agenda-item en ga naar het tabblad Ruimtes. De datum en de tijden worden overgenomen van de activiteit; je kiest alleen nog de ruimte. Verzet je de activiteit later naar een ander tijdstip, dan schuift de ruimte niet vanzelf mee — dat zou kunnen stuklopen op een inmiddels bezette ruimte. De tijd kleurt dan oranje met de tijd van de activiteit eronder, zodat je het ziet en zelf kiest.\n\n**Privé**\nZet een reservering op privé als niemand hoeft te weten waar hij voor is. De ruimte staat dan als bezet, zonder titel en zonder naam. Wie de rol Ruimteplanning heeft ziet wel alles — die moet immers kunnen plannen.\n\n**Dubbele boekingen**\nDie kunnen niet. Overlapt een reservering met een bestaande, dan krijg je te zien welke ruimte al bezet is en van wanneer tot wanneer. Aansluitend boeken mag wel: 10 tot 11 en 11 tot 12 botsen niet.",
            ],
            [
                'category'   => 'platform',
                'sort_order' => 22,
                'title'      => 'Ruimtes koppelen aan Microsoft 365',
                'body'       => "Deze koppeling zet reserveringen ook in de agenda van de ruimte, en haalt op wat er buiten VoetbalPlanner om is geboekt. Zonder die tweede richting kun je hier boeken op een ruimte die in Outlook al bezet is.\n\n**In Microsoft**\nElke ruimte moet een postbus zijn van het type *ruimte* (een resource mailbox). Maak daarnaast in Entra ID een app-registratie met een clientgeheim, en geef die de **applicatierechten** `Place.Read.All` en `Calendars.ReadWrite`, met beheerderstoestemming.\n\n**Beperk die registratie tot de ruimtes.**\nDit is de belangrijkste stap en hij wordt het vaakst overgeslagen. `Calendars.ReadWrite` geeft als applicatierecht toegang tot élke postbus in de organisatie, niet alleen tot de ruimtes. Stel in Exchange Online een ApplicationAccessPolicy in die de registratie beperkt tot een groep met alleen de ruimte-postbussen. Doe je dat niet, dan geef je VoetbalPlanner toegang tot de agenda van iedereen.\n\n**In de portal**\nOnder Instellingen → Ruimtes in Microsoft 365 vul je tenant-ID, client-ID en het clientgeheim in. Het geheim wordt versleuteld bewaard en nooit teruggetoond; laat het veld leeg om het te laten staan.\n\nGa daarna naar Beheer → Ruimtes en klik op **Ruimtes ophalen uit Microsoft**. Je ziet eerst wat er gevonden is en pas daarna voeg je toe. Komt die lijst leeg terug, dan zijn de ruimtes geen resource-postbussen of mist het recht Place.Read.All — dat zie je zo meteen, in plaats van pas bij een mislukte reservering.\n\nStaat een ruimte al in VoetbalPlanner? Vul dan het adres van de postbus in bij die ruimte zelf; dat is de koppelsleutel, niet de naam.\n\n**Hoe het loopt**\nEen reservering gaat meteen naar Outlook. Ligt Microsoft er even uit, dan gaat de reservering gewoon door — de ruimte is hier bezet en in het weekoverzicht staat \"nog niet in Outlook\" bij dat blok. Elke tien minuten probeert de server het opnieuw en haalt hij tegelijk op wat er in Outlook is bijgekomen.\n\nEen privé-reservering komt in Outlook te staan als \"Gereserveerd\", zonder de naam van de aanvrager. Alles wat daar staat is namelijk zichtbaar voor iedereen met agendarechten — juist voor de mensen die de rol Ruimteplanning niet hebben.\n\n**Afspraken uit Outlook**\nDie verschijnen hier als bezette blokken met een randje. Ze zijn hier niet aan te passen of in te trekken: dat hoort in Outlook te gebeuren, want de eerstvolgende ronde zou ze hier anders terugzetten.",
            ],
            [
                'category'   => 'platform',
                'sort_order' => 23,
                'title'      => 'Man of the match aanzetten',
                'body'       => "Elftallen kunnen na een wedstrijd anoniem de man of the match kiezen. Dat staat standaard uit en zet je per elftal aan.\n\n**Aanzetten**\nGa naar Beheer → Teams, open het elftal en zet **Man of the match-stemming** aan. Per elftal en niet per club, met opzet: bij de jongste jeugd is een stemming over wie de beste was zelden een goed idee, terwijl de senioren er juist om vragen.\n\n**Wat de leden zien**\nOp het tabblad Info van een wedstrijd komt een stemknop te staan — maar pas als er een wedstrijdverslag is. Zonder verslag weet niemand waar hij over stemt. Ze kiezen uit de spelers die meededen; op jezelf stemmen kan niet, en iedereen heeft één stem die daarna vaststaat.\n\n**Wie mag stemmen**\nIedereen die bij het elftal hoort, inclusief ouders die via hun kind gekoppeld zijn.\n\n**De uitslag** staat bij de wedstrijd onder Beheer → Wedstrijden, in het blok Man of the match. Alleen de uitslag: wie op wie heeft gestemd wordt nergens bewaard om te tonen — dat is de belofte die de app aan de stemmers doet, en daar zou een kijkje in de portal doorheen gaan.",
            ],
            // ── Koppelingen ───────────────────────────────────────────────────
            [
